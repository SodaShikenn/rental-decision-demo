...
The current chat is rule-based so that its reasoning remains easy to inspect. All properties, routes, rent histories, reviews, and facility scores are fictional demo data.
