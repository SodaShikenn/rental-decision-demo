...
export const markup = `<section class="feature-section" id="leisureSection" aria-labelledby="leisureSectionTitle"><h3 id="leisureSectionTitle">周辺の施設から探す</h3><p>候補の周りに何があるかを見てから、使いたい場所を考えます。</p><button class="button" id="discoverLeisure">全候補の公園・ジム・カフェを調べる</button><p id="leisureStatus" role="status"></p><div id="leisureResults"></div><div id="leisureQuestion"></div><div id="leisureConfirm"></div><details id="regularDestination" hidden><summary>すでに通っている場所と比べたい</summary><form id="regularForm" class="inline-form"><label>施設名・住所<input id="regularQuery" enterkeyhint="search" required minlength="2" maxlength="300" /></label><button class="button">場所を探す</button></form><div id="regularChoices"></div></details></section>`;
