...
export const markup = `<section class="feature-section" id="leisureSection" aria-labelledby="leisureSectionTitle"><h3 id="leisureSectionTitle" class="visually-hidden">周辺施設の検索</h3><button class="button button--primary" id="discoverLeisure">周辺施設を調べる</button><p id="leisureStatus" role="status"></p><div id="leisureResults"></div><div id="leisureQuestion"></div><div id="leisureConfirm"></div><details id="regularDestination" hidden><summary>すでに通っている場所と比べたい</summary><form id="regularForm" class="inline-form"><label>施設名・住所<input id="regularQuery" enterkeyhint="search" required minlength="2" maxlength="300" /></label><button class="button">場所を探す</button></form><div id="regularChoices"></div></details></section>`;
