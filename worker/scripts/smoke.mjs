// Post the fictional fixture sheet to a running Worker and compare each field with the ground truth.
// Usage: node scripts/smoke.mjs [baseUrl]   (default http://localhost:8787)
