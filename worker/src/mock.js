// Deterministic output for EXTRACTION_MODE=mock: lets the front end and tests run without
// calling Claude or spending credits. Values match the fictional test/fixtures/listing-sheet.png;
...
/** Mock model output in the same shape Claude returns, scaled to the uploaded image. */
export function mockOutput(image) {
